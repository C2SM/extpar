...
\tabularnewline\hline
itype\_scaling & integer & 1 & - & \textbf{Icon-only:} Power of the caling factor \textit{SIN(horizon-angle) }applied to the geometric skyview factor to account for the anisotropic nature of longwave radiation. 
\tabularnewline
\hline
\bottomrule
\end{longtable}
