...
The remapping to the target grid uses the \textit{bilinear} interpolation. After the remapping with CDO the field \textit{ISA} is scaled by a factor 0.01. No other processing steps take place. 
