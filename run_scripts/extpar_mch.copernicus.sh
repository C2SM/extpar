...
# balfrin and tasna
    ...
    data_dir=/scratch/mch/csteger/ExtPar/linked_data
...
if [[ $model == "c1" ]]; then
    ...
    ntiles_column=2
    ntiles_row=2
    topo_files="'Copernicus_DEM_N60-N50_W020-E000.nc' 'Copernicus_DEM_N60-N50_E000-E020.nc' 'Copernicus_DEM_N50-N40_W020-E000.nc' 'Copernicus_DEM_N50-N40_E000-E020.nc'"
