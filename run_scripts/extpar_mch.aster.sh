...
scriptdir=/scratch/juckerj/extpar_clean_cosmo_runscripts/run_scripts/
exedir=/scratch/juckerj/extpar_clean_cosmo_runscripts/bin/
sandboxdir=/scratch/juckerj/sandbox_extpar_full_domain/
