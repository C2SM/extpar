...
MODULE mo_aot_output_nc
  ...
  SUBROUTINE set_global_att_aot_CAMS(global_attributes)
    TYPE(netcdf_attributes), INTENT(INOUT) :: global_attributes(1:5)
    ...
    global_attributes(1)%attname = 'title'
    global_attributes(1)%attributetext='Mass of Aerosol  from CAMS'
    ...
    global_attributes(5)%attname = 'references'
    global_attributes(5)%attributetext='created by bozzo in 2020..'

  END SUBROUTINE set_global_att_aot_CAMS
!----------------------------------------------------------------------------
...
!gs_21.03.12
  ...
  SUBROUTINE read_netcdf_buffer_aot_CAMS (netcdf_filename,     &
   ...
   &                                      CAMS_tg)
    ...
    CALL logging%info('Enter routine: read_netcdf_buffer_aot_CAMS')
