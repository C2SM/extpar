...
PROGRAM extpar_topo_to_buffer
  ...
  !  INTEGER (i4) :: topo_startrow(1:ntiles)    !< startrow indeces for each GLOBE tile
  !  INTEGER (i4) :: topo_endrow(1:ntiles)      !< endrow indeces for each GLOBE tile
  !  INTEGER (i4) :: topo_startcolumn(1:ntiles) !< starcolumn indeces for each GLOBE tile
  !  INTEGER (i4) :: topo_endcolumn(1:ntiles)   !< endcolumn indeces for each GLOBE tile
  ...
  print *, 'Output filename: ',TRIM(netcdf_filename)
