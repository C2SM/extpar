...
CONTAINS
  ...
  SUBROUTINE write_netcdf_buffer_topo(netcdf_filename, &
    ...
    REAL (KIND=wp), INTENT(IN)           :: lon_geo(:,:,:)          !< longitudes of the target grid in the geographical system
    REAL (KIND=wp), INTENT(IN)           :: lat_geo(:,:,:)          !< latitudes of the target grid in the geographical system
