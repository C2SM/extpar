...
#--------------------------------------------------------------------------
    ...
    for idx_lin in np.unique(idx_lin_tile):
        ...
        # print(np.rad2deg(lon_vert_tile.min()), np.rad2deg(lon_vert_tile.max()))
        # print(np.rad2deg(lat_vert_tile.min()), np.rad2deg(lat_vert_tile.max()))
        ...
        with xr.open_mfdataset(
            ...
            # print(ds["lon"].values[[0, -1]], ds["lat"].values[[0, -1]])
            ds = ds.sel(
